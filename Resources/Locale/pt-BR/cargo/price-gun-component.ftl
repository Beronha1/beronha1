...
price-gun-pricing-result = O dispositivo avalia {THE($object)} em {$price} spesos.
price-gun-verb-text = Avaliação
price-gun-verb-message = Avaliar {THE($object)}.
price-gun-bounty-complete = O dispositivo confirma que a recompensa contida nele foi concluída.
price-gun-salvjob-complete = O dispositivo confirma que o serviço de salvage contido nele foi concluído.
