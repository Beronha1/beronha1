...
bounty-console-description-label= [color=cinza]{$description}[/color]
bounty-console-id-label = ID#{$id}

bounty-console-flavor-left = Recompensas obtidas de traficantes locais sem escrúpulos.
bounty-console-flavor-right = v1.4

bounty-manifest-header = [font size=14][bold]Manifesto oficial de recompensas de carga[/bold] (ID#{$id})[/font]
bounty-manifest-list-start = Lista de manifesto:

bounty-console-tab-available-label = Disponíveis
bounty-console-tab-history-label = Histórico
bounty-console-history-empty-label = Nenhum histórico de recompensa encontrado
bounty-console-history-notice-completed-label = [color=limegreen]Concluída[/color]
