...
cosmiccult-roundend-cultist-count = { $initialCount ->
    [1] Houve {$initialCount} [color=#4cabb3]Cultista Cosmico[/color].
    *[other] Houve {$initialCount} [color=#4cabb3]Cultistas Cosmicos[/color].
}
cosmiccult-roundend-entropy-count = O culto absorveu {$count} Entropia.
...
cosmiccult-role-short-briefing =
    Voce e um Cultista Cosmico!
    Seus objetivos estao listados no menu do personagem.
...
cosmiccult-role-conversion-briefing =
    Voce e um Servo Cosmico!
    Seus objetivos estao listados no menu do personagem.
    Leia mais sobre seu papel na entrada do guia.

cosmiccult-role-deconverted-fluff =
    Uma grande vazio atravessa sua mente. Um vazio confortavel, mas desconhecido...
    Todos os pensamentos e memorias do seu tempo no culto comecam a esmaecer e desfocar.
...
cosmiccult-role-levelup-awaiting-input =
    Voce juntou entropia o suficiente para atingir um novo nivel de poder.
    Ajuste sua Influencia para mais informacoes.
...
cosmiccult-ui-deconverted-title = Desconversao
cosmiccult-ui-converted-title = Convertido
cosmiccult-ui-roundstart-title = O Desconhecido

cosmiccult-ui-converted-text-1 =
    Voce foi convertido em um Servo Cosmico.
cosmiccult-ui-converted-text-2 =
    Apesar de ter recebido conhecimento, voce nao possui o poder que seus colegas cultistas possuem.
    Ajude o culto em seus objetivos enquanto preserva o segredo.
...
cosmiccult-silicon-subverted-briefing =
    ...
    Suas leis foram subvertidas pelo Culto Cosmico!

cosmiccult-silicon-chantry-briefing =
    Voce foi preso em uma Chantry Vazia!
    Colegas podem liberar voce danificando a chantry com armas.
    Se o ritual da chantry completar, voce sera transfigurado em um Colosso Entropico alinhado com o culto.
    O ritual se completara em {$minutesandseconds}.

cosmiccult-silicon-colossus-briefing =
    Voce foi transfigurado em um Colosso Entropico!
    Como uma muralha colossal de poder maligno, decime aqueles que se opuserem a voce.

cosmiccult-mindshield-popup = Uma erupcao de energia maligna rompe o implante!
