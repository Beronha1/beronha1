...
ingestion-verb-food = Coma
ingestion-verb-drink = Beber

# Edible Component

-edible-satiated= { $satiated ->
    [true] {" "}Você não sente mais que poderia { $verb }.
  *[false] {""}
}

edible-nom = Nome. {$flavors}{ -edible-satiated(satiated: $satiated, verb: "eat") }
edible-nom-other = Nome.
edible-slurp = Sorvete. {$flavors}{ -edible-satiated(satiated: $satiated, verb: "drink") }
edible-slurp-other = Sorvete.
edible-swallow = Você engole { THE($food) }.{ -edible-satiated(satiated: $satiated, verb: "swallow") }
...
edible-force-feed= {CAPITALIZE(THE($user))} está tentando fazer com que você {$verb} alguma coisa!
