...
public sealed partial class ESObjectiveControl : BoxContainer
{
    ...
    public void SetObjective(EntityUid objective)
    {
        ...
        TitleLabel.SetMarkup(Loc.GetString("es-character-window-objective-title-fmt", ("title", metaData.EntityName)));
        DescriptionLabel.SetMarkup(Loc.GetString("es-character-window-objective-desc-fmt", ("text", metaData.EntityDescription)));
