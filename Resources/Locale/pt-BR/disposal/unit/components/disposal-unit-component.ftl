...
disposal-unit-is-full = Não há mais espaço lá dentro.
...
# putting people in
disposal-unit-being-inserted= {CAPITALIZE($user)} está tentando forçar você a entrar em uma rampa de descarte!
