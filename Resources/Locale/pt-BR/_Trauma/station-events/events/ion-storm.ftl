...
ion-storm-law-job-change = TODOS OS(A) {ION-JOB($ion)} DEVEM MUDAR PARA {ION-JOB($ion)}
# THE ASSISTANTS HAVE MORE AUTHORITY THAN CAPTAINS with nt default
ion-storm-law-job-authority = OS(A) {ION-JOB($ion)} TEM MAIS AUTORIDADE QUE OS(A) {ION-JOB($ion)}
