...
public sealed partial class ESGenericPointLightVisualizerSystem : VisualizerSystem<ESGenericPointLightVisualizerComponent>
{
    ...
    protected override void OnAppearanceChange(EntityUid uid,
        ESGenericPointLightVisualizerComponent component,
        ref AppearanceChangeEvent args)
    {
        ...
        DebugTools.Assert(!pointLight.NetSyncEnabled,
            $"Entity {ToPrettyString(uid)} uses point light visuals with a netsync'd pointlight!");
