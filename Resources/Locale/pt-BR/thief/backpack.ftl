...
thief-backpack-window-description =
    Dentro estão suas ferramentas de trabalho, que serão dissolvidas quando você estiver pronto.
...
thief-backpack-category-chameleon-description =
    ...
    um projetor camaleão e um implante de escudo mental falso.
...
thief-backpack-category-chemistry-description =
    ...
    Inclui: Implantador de armazenamento, implantador de mistura de DNA,
...
thief-backpack-category-communicator-description =
    ...
    implantador de máscara de voz e 20 mil spesos dentro de uma pasta.
