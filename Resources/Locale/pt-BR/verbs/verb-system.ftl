...
verb-system-null-server-response =Entidade não visível. Você não deveria ver isso.
...
verb-categories-smite = Ferir
verb-categories-tricks = Truques
verb-categories-transfer = Definir valor da transferência
