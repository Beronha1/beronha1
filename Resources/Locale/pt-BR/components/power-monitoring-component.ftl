...
power-monitoring-window-object-array = matriz de {$name} [{$count}]
...
power-monitoring-window-total-battery-usage = Uso total das baterias
...
power-monitoring-window-rogue-power-consumer = [color=white][font size=14][bold]! AVISO — DISPOSITIVO COM CONSUMO IRREGULAR DE ENERGIA DETECTADO ![/bold][/font][/color]
