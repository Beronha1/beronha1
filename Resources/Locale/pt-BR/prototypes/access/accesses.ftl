...
id-card-access-level-emergency-shuttle-repeal = Revogar todos da nave de emergência
...
id-card-access-level-chief-medical-officer = Diretor médico
id-card-access-level-medical = Medicina
...
id-card-access-level-syndicate-agent = Agente do Syndicate
