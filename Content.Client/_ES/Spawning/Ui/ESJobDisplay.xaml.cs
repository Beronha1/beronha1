...
public sealed partial class ESJobDisplay : BoxContainer
{
    ...
    private readonly HumanoidProfileSystem _humanoidProfile;
    ...
    public ESJobDisplay()
    {
        ...
        _humanoidProfile = _entityManager.System<HumanoidProfileSystem>();
    ...
    public void SetJob(ProtoId<JobPrototype> job)
    {
        ...
        _doll = jobProto.JobEntity is null
            ? _entityManager.Spawn(_prototypeManager.Index(HumanoidCharacterProfile.DefaultSpecies).DollPrototype)
        ...
        _humanoidProfile.ApplyProfileTo(_doll, defaultDude);
