...
comp-solution-transfer-verb-amount= {$amount}você
comp-solution-transfer-verb-toggle = Trocar para {$amount}u
...
comp-solution-transfer-set-amount-max = Máximo: {$amount}u
