...
delivery-earnings-examine = Entregar isso renderá a estação [color=yellow]{$spesos}[/color] spesos.
...
# modifiers
delivery-priority-examine = Esta é uma prioridade [color=orange]{$type}[/color]. Você tem [color=orange]{$time}[/color] restante para entregá-lo e ganhar um bônus.
