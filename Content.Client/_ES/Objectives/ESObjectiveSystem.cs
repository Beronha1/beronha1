...
public sealed class ESObjectiveSystem : ESSharedObjectiveSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ESObjectiveHolderComponent, AfterAutoHandleStateEvent>(OnHolderAfterAutoHandleState);
        SubscribeLocalEvent<ESObjectiveComponent, AfterAutoHandleStateEvent>(OnObjectiveAfterAutoHandleState);
    }

    private void OnHolderAfterAutoHandleState(Entity<ESObjectiveHolderComponent> ent, ref AfterAutoHandleStateEvent args)
    {
