...
random-sentience-event-data-2 = nossos modelos probabilísticos sofisticados
random-sentience-event-data-3 = nosso poder omnipotente
random-sentience-event-data-4 = o tráfego de comunicações em sua estação
random-sentience-event-data-5 = as emissões de energia que detectamos
random-sentience-event-data-6= [REMOVIDO]
...
station-event-random-sentience-announcement = Com base em { $data }, acreditamos que alguns { $amount ->
    [1] { $kind1 }
    [2] { $kind1 } e { $kind2 }
    [3] { $kind1 }, { $kind2 } e { $kind3 }
    *[other] { $kind1 }, { $kind2 }, { $kind3 }, etc.
} seres desenvolveram inteligência de nível { $strength } e capacidade de se comunicar.

## Ghost role description

station-event-random-sentience-role-description = Você é um { $name } senciente, trazido à vida por magia espacial.
