...
uplink-syndicate-id-card-name = Cartão de ID da Sindicate
uplink-syndicate-id-card-desc = Um cartão de ID da Sindicate, com acesso da Sindicate. Pouco útil sozinho, mas combina muito com portas reconfiguradas. Não vem com função de copiar acesso.

uplink-agent-id-card-name = Carteira de ID de agente
uplink-agent-id-card-desc = Um cartão de ID modificado que pode copiar acessos de outros cartões e mudar seu nome e cargo à vontade.
...
uplink-travel-camera-desc = Atordoe pessoas com suas habilidades fotográficas e com o flash de câmera legalmente conveniente. Faz você parecer um turista.

uplink-smuggler-satchel-name = Sacola do contrabandista
uplink-smuggler-satchel-desc = Uma bolsa prática e suspeita. Fina o suficiente para caber sob azulejos de piso.
