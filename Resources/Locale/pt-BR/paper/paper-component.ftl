...
paper-ui-blank-page-message = Esta página foi deixada em branco de propósito
...
paper-component-illiterate-mime = Seu voto impede você de escrever.
...
paper-tamper-proof-modified-message = Esta página foi escrita com tinta inviolável.
