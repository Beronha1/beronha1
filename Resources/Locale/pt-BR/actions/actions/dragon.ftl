devour-action-popup-message-structure = Suas mandíbulas penetram em material espesso..
...
dragon-spawn-action-popup-message-fail-no-eggs = Você não tem resistência suficiente para isso!
