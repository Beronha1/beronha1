...
ntr-document-security-document-text =
    {$start}
    A Corporação quer que você verifique algumas coisas antes de carimbar este documento, garantindo que {$text1} {$text2}
    {$text3}
    {$text4}
...
ntr-document-science-document-text =
    {$start}
    Monitoramos de perto o Departamento de Pesquisa. {$text1} {$text2}
