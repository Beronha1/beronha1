...
examine-trigger-timer = O cronômetro está definido para {$time} segundos.
...
popup-start-on-stick-on = O dispositivo agora será ativado automaticamente quando plantado
