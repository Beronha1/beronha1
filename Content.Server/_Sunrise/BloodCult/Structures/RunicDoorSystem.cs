...
public sealed partial class RunicDoorSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        // 🌇Sunset🌇 - this fork's BeforeDoorClosedEvent carries no User field (closing has no reliable
        // "who" - auto-close included), so only the open-side deny/zap/throw check is portable here.
    }
