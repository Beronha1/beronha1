...
anomaly-vessel-component-not-assigned = Este recipiente não está associado a nenhuma anomalia. Tente usar um escâner nele.
anomaly-vessel-component-assigned = Este recipiente está associado a uma anomalia.
...
anomaly-scanner-component-scan-complete = Varredura concluída!
anomaly-scanner-ui-title = escâner de anomalias
...
anomaly-scanner-stability-low = Estado atual da anomalia: [color=gold]Em decaimento[/color]
anomaly-scanner-stability-medium = Estado atual da anomalia: [color=forestgreen]Estável[/color]
anomaly-scanner-stability-high = Estado atual da anomalia: [color=crimson]Em crescimento[/color]
...
anomaly-command-pulse = Emite um pulso na anomalia-alvo
...
anomaly-behavior-delayed-force = A frequência das pulsações foi bastante reduzida, mas sua potência aumentou.
anomaly-behavior-rapid = A frequência das pulsações é muito maior, mas sua potência foi atenuada.
...
anomaly-behavior-invisibility = Foi detectada distorção de ondas luminosas.
anomaly-behavior-secret = Interferência detectada. Não foi possível ler alguns dados.
anomaly-behavior-inconstancy = [color=crimson]Impermanência detectada. Os tipos de partícula podem mudar com o tempo.[/color]
