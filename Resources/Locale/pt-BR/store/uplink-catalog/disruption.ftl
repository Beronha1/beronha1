...
uplink-singularity-grenade-name = Granada de supermatéria
uplink-singularity-grenade-desc = Granada que simula delaminação do reator de supermatéria, gera um poço gravitacional poderoso. Explosão comparável a uma mini-bomba.
...
uplink-syndicate-martyr-module-desc = Transforme seu amigo borg emagrede pelo emag em uma bomba ambulante com só este módulo. Certifique-se de que ele seja leal à sua causa, os resultados podem variar.

uplink-soap-name = Sabão
uplink-soap-desc = Uma barra de sabão pouco confiável. Cheira medo.

uplink-slipocalypse-clustersoap-name = Clustersoap da Armadilha
uplink-slipocalypse-clustersoap-desc = Espalha pequenos pedaços de sabão com marca da Sindicate após ser arremessado; estes pedaços evaporam após 60 segundos.

uplink-toolbox-name = Caixa de ferramentas
uplink-toolbox-desc = Um conjunto completo de ferramentas para o traidor com inclinação mecânica. Inclui uma dupla de luvas de combate isoladas e uma máscara de gás da Sindicate.

uplink-syndicate-jaws-of-life-name = Mandíbulas da morte
uplink-syndicate-jaws-of-life-desc = Uma ferramenta combinada de alavanca e corte. Útil para entrar na estação ou em seus departamentos. Pode até abrir portas travadas.

uplink-duffel-surgery-name = Bolsa cirúrgica de pano
uplink-duffel-surgery-desc = Uma bolsa de pano grande contendo um conjunto completo de ferramentas cirúrgicas.

uplink-syndimov-law-name = Kit de circuito de lei Syndi
...
uplink-starter-kit-name = Pacote básico de operador
uplink-starter-kit-desc = Contém tudo que um operador precisa para começar. Para quem não sabe o que comprar.

uplink-singularity-beacon-name = Baliza de singularidade
