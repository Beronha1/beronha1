...
public sealed partial class ESWarpDriveSystem
{
    ...
    {
        SubscribeLocalEvent<ESWarpDriveComponent, PortalTeleportedEntityEvent>(OnWarpDriveTeleport);
    }

    private void OnWarpDriveTeleport(Entity<ESWarpDriveComponent> ent, ref PortalTeleportedEntityEvent args)
    {
