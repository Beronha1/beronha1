...
| Proto-Kinetic Shockwave icon/empty animation and Railgun/Shockwave firing sounds | Paradise `f6b562e6b604f02596861117ea68a2d08e609c2a`; `icons/obj/guns/energy.dmi`, `sound/weapons/beam_sniper.ogg` and `sound/weapons/cannon.ogg` | Exact frames and sounds imported under Paradise's default CC-BY-SA-3.0 media license. Each destination RSI/audio directory records the commit and source. The existing Bubber-attributed railgun RSI is reused unchanged. No image generation or pixel redrawing was performed. |
| Paradise railgun, shockwave and SPLURT kinetic modkit behavior | Paradise `f6b562e6b604f02596861117ea68a2d08e609c2a` and SPLURT mining/modkit definitions used as behavior references | No BYOND/DM source was copied. Weapon safety, mob penetration, directional shockwave, boss trophy effects and common/rare modkits were reimplemented in C# ECS and rewritten YAML for Whiskey's existing research and Cargo economy. |
