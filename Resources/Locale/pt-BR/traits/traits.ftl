...
permanent-blindness-trait-examined = [color=lightblue]{CAPITALIZE(POSS-ADJ($target))} olhos estão vidrados e desfocados. Não parece que {SUBJECT($target)} pode ver você bem, se é que consegue.[/color]
...
trait-newyork-name = Sotaque de Nova York
trait-newyork-desc = Você fala com um forte sotaque nova-iorquino. Estou andando aqui!

trait-british-name = Sotaque britânico
trait-british-desc = Você fala direito, ao contrário daqueles malditos idiotas.
