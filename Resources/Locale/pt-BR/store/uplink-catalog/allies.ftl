...
uplink-holopara-kit-desc = O orgulho e alegria da Cybersun. Contém um injetor que abriga um guardião metafísico senciente feito de luz dura que reside no corpo do usuário quando não está ativo.
    O guardião pode socar rapidamente e é imune a ambientes perigosos enquanto resiste a trauma direto, mas divide qualquer dano que recebe com o usuário.
    Não pode ser usado por changelings.

uplink-reinforcement-radio-name = Teletransportador de reforço
uplink-reinforcement-radio-traitor-desc = Rádio para reforçar uma operação com um agente de qualidade extremamente duvidosa. Sem botão de desligar, compre isso se estiver pronto para a festa. Chame um médico, espião ou ladrão para te ajudar. Boa sorte.

uplink-reinforcement-radio-nukeops-name = Teletransportador de operador nuclear
