...
time-transfer-panel-warning-no-job = Cargo não selecionado
...
time-transfer-panel-no-player-database-message = Jogador não encontrado Não banco de dados

# Please change it if you really-really need to do it
time-transfer-panel-author = Feito por BombasterDS para o Goobstation
